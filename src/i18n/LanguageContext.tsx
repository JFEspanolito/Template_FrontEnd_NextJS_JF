...
const translations = {
  ES: {
    ...
    // Analytics / Cookies
    cookieBanner: "Usamos cookies para analitica (GA/Clarity). Aceptas?",
    cookieAccept: "Aceptar",
    cookieDecline: "Rechazar",
    cookieAcceptLabel: "Aceptar cookies de analitica",
    cookieDeclineLabel: "Rechazar cookies de analitica",
  },
  EN: {
    // Header
    menu1: "Menu 1",
    ...
    // Analytics / Cookies
    cookieBanner: "We use cookies for analytics (GA/Clarity). Do you accept?",
    cookieAccept: "Accept",
    cookieDecline: "Decline",
    cookieAcceptLabel: "Accept analytics cookies",
    cookieDeclineLabel: "Decline analytics cookies",
  },
};
